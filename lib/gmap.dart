...
class GMap extends StatefulWidget {
  GMap({required Key key}) : super(key: key);
...
class _GMapState extends State<GMap> {
  ...
  void _setMarkerIcon() async {
    _markerIcon =
        await BitmapDescriptor.fromAssetImage(ImageConfiguration(), 'assets/location_icon.png');
  }
  ...
  void _setPolylines() {
  List<LatLng> polylineLatLongs = []; // Change list declaration here
